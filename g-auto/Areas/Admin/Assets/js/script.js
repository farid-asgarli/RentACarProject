...
$(document).ready(function () {
    ...
    //var urlSplit = ;
    if ((window.location.href.split('/')).indexOf("Brand") >= 0) {
        ...
        $.getJSON(countryAPI).done(function (data) {
            ...
            alert("There was an error while retrieving 'Countries' API.")
        });
    }
    ...
    var appdate_$input = jQuery('#input_date').pickadate({
